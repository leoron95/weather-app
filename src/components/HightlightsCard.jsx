...
export const HightlightsCard = ({wind_mph, humidity, vis_miles, pressure_mb, wind_dir}) => {
...
return (
   <>
    <div className='h-52 w-full bg-[#1E213A] flex flex-col items-center  '>
        ...
        <p className='text-[#E7E7EB] text-sm font-medium leading-4 mt-8'>{wind_dir}</p>
    </div>
    ...
    <div className='h-52 w-full bg-[#1E213A] flex flex-col items-center '>
        ...
        <p className='text-[#E7E7EB] text-[64px] font-bold leading-[75px]'>{humidity}<span className='text-4xl font-medium'>%</span></p>
    ...
    <div className='h-40 w-full bg-[#1E213A] flex flex-col items-center '>
        ...
        <p className='text-[#E7E7EB] text-[64px] font-bold leading-[75px]'>{pressure_mb}<span className='text-4xl font-medium'> mb</span></p>
